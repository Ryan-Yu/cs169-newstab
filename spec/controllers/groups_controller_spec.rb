...
describe GroupsController do
  ...
  #       post :create, {:group => { "user_id" => "invalid value" }}, valid_session
  #       assigns(:group).should be_a_new(Group)
  #     end
  ...
  #       Group.any_instance.should_receive(:update).with({ "user_id" => "1" })
  #       put :update, {:id => group.to_param, :group => { "user_id" => "1" }}, valid_session
  #     end
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Group.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => group.to_param, :group => { "user_id" => "invalid value" }}, valid_session
  #       assigns(:group).should eq(group)
  #     end
